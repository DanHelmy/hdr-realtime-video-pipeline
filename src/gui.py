...
class MainWindow(
    ...
    def __init__(self, initial_video=None, initial_resolution=None,
                 ...
                 initial_capture_hwnd=None,
                 initial_capture_session_id=None,
        ...
        self._queue_initial_video_open(
            ...
            initial_source_mode=initial_source_mode,
            initial_capture_hwnd=initial_capture_hwnd,
            initial_capture_session_id=initial_capture_session_id,
            initial_capture_title=initial_capture_title,
