...
class SignalWiringMixin:
    ...
    def _connect_signals(self):
        ...
        self._cmb_capture_fps.currentTextChanged.connect(self._on_capture_fps_changed)
        self._cmb_capture_fps.currentTextChanged.connect(lambda _v: self._save_user_settings())
