...
PRECISIONS = {
    "FP16": {
        ...
        "trt_model": _weight("distilled/hr/HR_qfriendly_spatialmixglobal_fp32.pt"),
        "trt_model_nohg": _weight("distilled/hr/HR_qfriendly_spatialmixglobal_fp32.pt"),
    ...
    "INT8 Mixed (PTQ)": {
        ...
        "trt_model": _weight("distilled/hr_hg/HR_HG_qfriendly_spatialmixglobal_int8_mixed_ptq.pt"),
        "trt_model_nohg": _weight("distilled/hr/HR_qfriendly_spatialmixglobal_int8_mixed_ptq.pt"),
    ...
    "INT8 Mixed (QAT)": {
        ...
        "trt_model": _weight("distilled/hr_hg/HR_HG_qfriendly_spatialmixglobal_int8_mixed_qat.pt"),
        "trt_model_nohg": _weight("distilled/hr/HR_qfriendly_spatialmixglobal_int8_mixed_qat.pt"),
    ...
    "INT8 Mixed (QAT) (Film)": {
        ...
        "trt_model": _weight("distilled/hr_hg/HR_HG_qfriendly_spatialmixglobal_int8_mixed_qat_film.pt"),
        "trt_model_nohg": _weight("distilled/hr/HR_qfriendly_spatialmixglobal_int8_mixed_qat_film.pt"),
    ...
    "INT8 Full (PTQ)": {
        ...
        "trt_model": _weight("distilled/hr_hg/HR_HG_qfriendly_spatialmixglobal_int8_full_ptq.pt"),
        "trt_model_nohg": _weight("distilled/hr/HR_qfriendly_spatialmixglobal_int8_full_ptq.pt"),
    ...
    "INT8 Full (QAT)": {
        ...
        "trt_model": _weight("distilled/hr_hg/HR_HG_qfriendly_spatialmixglobal_int8_full_qat.pt"),
        "trt_model_nohg": _weight("distilled/hr/HR_qfriendly_spatialmixglobal_int8_full_qat.pt"),
    ...
    "INT8 Full (QAT) (Film)": {
        ...
        "trt_model": _weight("distilled/hr_hg/HR_HG_qfriendly_spatialmixglobal_int8_full_qat_film.pt"),
        "trt_model_nohg": _weight("distilled/hr/HR_qfriendly_spatialmixglobal_int8_full_qat_film.pt"),
