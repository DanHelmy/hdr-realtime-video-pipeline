...
-----
    ...
    python quantize_int8_full_qat.py --epochs 10 --lr 1e-5

    # Start fresh (PTQ + QAT from FP32, no existing full checkpoint needed)
    python quantize_int8_full_qat.py --from-scratch
"""
...
def main():
    ...
    parser.add_argument("--output",
                        default="src/models/weights/Ensemble_AGCM_LE_int8_full_qat.pt",
