...
def train_qat(model, pairs, device, compute_dtype, args,
    ...
    if frozen_layer_names:
        print("  Strategy: teacher-anchored full QAT "
...
def main():
    ...
    parser.add_argument("--output",
                        default=os.path.join(
                            ...
                            "pytorch_int8",
                            "hg",
                            "HR_HG_original_int8_full_qat.pt",
                        ),
    ...
    parser.add_argument("--dark-loss-weight", type=float, default=0.06,
                        help="Extra L1 weight on non-black shadow/detail pixels")
    parser.add_argument("--dark-teacher-weight", type=float, default=0.12,
    ...
    parser.add_argument("--freeze-sensitive-layers", default="1", choices=["1", "0"],
                        help="Freeze a curated set of tone/color-sensitive layers during full QAT")
